...
{        
        ...
        self->parent = PyWeakref_NewRef(object, NULL);
        ///COUT << "newref: Py_REFCNT: " << Py_REFCNT(self->parent) << ENDL;

        //auto weakref = PyWeakref_NewRef(object, NULL);
        //self->weakref_parent = weakref;
...
/*{
        ...
        COUT << "weakref Py_REFCNT: " << Py_REFCNT(parent) << ENDL;

        auto no = (Py_node_object*) parent;
        auto node_ptr = Py_get<GL::dummy_node>(no->node_ptr);
        COUT << "weakref name: " << node_ptr->name_ << ENDL;
}*/
    }
...
static PyObject *
Py_node_getparent(Py_node_object *self, void *closure)
{
    __function__
{
    auto node_ptr = Py_get<GL::dummy_node>(self->node_ptr);
...
static int
Py_node_setparent(Py_node_object *self, PyObject *value, void *closure)
{
    __function__
    ...
    self->parent = PyWeakref_NewRef(value, NULL);
...
static PyGetSetDef Py_node_getsetters[] = {
    {"parent", (getter) Py_node_getparent, (setter) Py_node_setparent,
     "first name", NULL},
